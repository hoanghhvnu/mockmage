 ...
 * Time: 09:41
 */
class Training_Album_Block_Adminhtml_Album_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('album_data') && Mage::registry('album_data')->getId() ) {
            return Mage::helper('album')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('album_data')->getTitle()));
        } else {
            return Mage::helper('album')->__('Add Item');
        }
    }
}